...
function ExamModal(props) {
	...
	const handleGetCategoryName = (bookId) => {
		const result = categories.filter((o) => o._id === bookId);
	...
	const handleSubmit = async (values) => {
		const { _id, name, bookId, part1Audio, part2Audio, part3Audio, part4Audio } =
			values;
	...
	return (
		...
		<CModalFooter>
			...
			<CButton color="primary" type="submit" form='form'>Save changes</CButton>
		</CModalFooter>
	</CModal>
